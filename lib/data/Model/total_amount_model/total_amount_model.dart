...
class TotalAmountModel {
  ...
  factory TotalAmountModel.fromJson(Map<String, dynamic> json) => TotalAmountModel(
    ...
    totals: json["totals"] == null ? null : TotalAmountModelTotals.fromJson(json["totals"]),
...
class TotalAmountModelTotals {
  ...
  factory TotalAmountModelTotals.fromJson(Map<String, dynamic> json) => TotalAmountModelTotals(
    subtotal: json["subtotal"],
    subtotalTax: json["subtotal_tax"],
