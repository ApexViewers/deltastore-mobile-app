...
//
//     final incrementAmountModel = incrementAmountModelFromJson(jsonString);

import 'dart:convert';

IncrementAmountModel incrementAmountModelFromJson(String str) => IncrementAmountModel.fromJson(json.decode(str));

String incrementAmountModelToJson(IncrementAmountModel data) => json.encode(data.toJson());

class IncrementAmountModel {
  String? cartHash;
  String? cartKey;
  Currency? currency;
  Customer? customer;
  ...
  factory IncrementAmountModel.fromJson(Map<String, dynamic> json) => IncrementAmountModel(
    ...
    totals: json["totals"] == null ? null : IncrementAmountModelTotals.fromJson(json["totals"]),
    removedItems: json["removed_items"] == null ? [] : List<RemovedItem>.from(json["removed_items"]!.map((x) => RemovedItem.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "removed_items": removedItems == null ? [] : List<dynamic>.from(removedItems!.map((x) => x.toJson())),
    "cross_sells": crossSells == null ? [] : List<dynamic>.from(crossSells!.map((x) => x)),
    "notices": notices == null ? [] : List<dynamic>.from(notices!.map((x) => x)),
  };
}
...
class IncrementAmountModelTotals {
  String? subtotal;
  String? subtotalTax;
  String? feeTotal;
  String? feeTax;
  ...
  factory IncrementAmountModelTotals.fromJson(Map<String, dynamic> json) => IncrementAmountModelTotals(
    subtotal: json["subtotal"],
    subtotalTax: json["subtotal_tax"],
