...
class LenovoLaptopProductComponent extends StatelessWidget {
  LenovoLaptopProductComponent({super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: Obx(
              () =>  lenovoLaptopController.lenovocategoriesLoading.value
              ? const ShimmerEffectLoading()
              :  lenovoLaptopController.lenovocategoriesError.value != ''
              ? Center(
              child: Column(
                ...
                children: [
                  ...
                  Text( lenovoLaptopController.lenovocategoriesError.value),
                ],
              ))
              : ListView.builder(
            scrollDirection: Axis.horizontal,
            itemCount:  lenovoLaptopController.lenovoLaptopModel.length,
              ...
              return InkWell(
                onTap: () {
                  ProductidController.productById(
                      lenovoLaptopController.lenovoLaptopModel[index].id!);
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(
                            ...
                            width: 29.w,
                            child: Center(
                                child:  lenovoLaptopController.lenovoLaptopModel[index]
                                    .images![0]
                                    .src!
                                    .isEmpty
                                ...
                                Row(
                                  ...
                                  children: [
                                    SizedBox(
                                      width: 40.w,
                                      child: Text(
                                        lenovoLaptopController.lenovoLaptopModel[index].name
                                            .toString(),
                                        maxLines: 2,
